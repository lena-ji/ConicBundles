...
-- Cleanly outputs the header and its content
Clean = (header, content) -> (print(concatenate({header, toString(content)})););
...
-- << "Roots of the Discriminant Polynomial: " << roots(Disc, Unique=>true)
Clean("Discriminant Polynomial: ", Disc);
Clean("Roots of the Discriminant Polynomial: ", roots(Disc, Unique=>true));
...
Clean("Partial Derivative of Delta_s (to x): ", partial_disc_(0, 0));
Clean("Partial Derivative of Delta_s (to y): ", partial_disc_(0, 1));
Clean("Partial Derivative of Delta_s (to z): ", partial_disc_(0, 2));

-- Computing Res_3(\partial_x \Delta_s, \partial_y \Delta_s, \partial_z \Delta_s)
...
Clean("Remainder of Resultant Divided by Discriminant: ", rem);

-- Find the Root of the Resultant
-- << "Roots of the Resultant: " << roots(P, Unique=>true)
Clean("Roots of the Resultant: ", roots(P, Unique=>true));
